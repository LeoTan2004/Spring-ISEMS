...
public interface RoleMapper extends BaseMapper<Role> {
    ...
    List<Role> getByUser(@Param("uid") Long uid, @Param("offset") Long offset);
    ...
    @Select("select rid, rel_tid, name, permissions, roles.insert_time, roles.update_time " +
            ...
            "and rel_rid = rid " +
            "and rel_uid = #{uid}")
    Role getByUserAndTeam(@Param("uid") Long uid,@Param("tid") Long tid);
    ...
    List<Role> getByTeam(@Param("tid") Long tid, @Param("offset") Long offset);

    @Select("select rid, rel_tid, name, permissions, roles.insert_time, roles.update_time from roles " +
            "where rel_tid=#{tid} and name  = #{name};")
    Role getByTeamAndName(@Param("tid") Long tid, @Param("name") String name);
